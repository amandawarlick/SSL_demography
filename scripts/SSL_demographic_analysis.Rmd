...
Process model -- True states were defined by an individual's age, sex, and reproductive states. Immature age classes included pups, dependent young (yearlings and age-2 individuals), and individuals age 3-5 that have not yet entered the breeding population (pre-breeders). Adult female states included breeders age at 4, at age 5, and at ages 6+ and reproductively mature individuals at ages 5+ that are not breeding in a given year (non-breeders). Adult males were defined as individuals at ages 6+ (`r figs('life_cyc', display = 'cite')`). The state process model,
