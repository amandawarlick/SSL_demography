...
waic_singles <- read.csv(file = here::here('results', 'waic_vals_singles.csv'),
  ...
  transform(Var = factor(Var, levels = c('albsa', 'AOI', 'chla', 'MEI', 'NOI', 'npgo', 'NPI',
                                         'PDO', 'prod', 'sst', 'up', 
                                         'uwnd', 'vwnd', 'scal', 'curl'),
                         labels = c('AL', 'AOI', 'chla', 'MEI', 'NOI', 'NPGO', 'NPI',
                                         'PDO', 'Productivity', 'SST', 'Upwelling', 
